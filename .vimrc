...
au BufRead,BufNewFile *.{c,h,java,hpp,cpp,cc,ml} set expandtab
au BufRead,BufNewFile *.{c,h,java,hpp,cpp,cc,ml} set shiftwidth=2
au BufRead,BufNewFile *.{c,h,java,hpp,cpp,cc,ml} set tabstop=2
